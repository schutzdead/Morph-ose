        ...
        <div className="w-[100vw] flex flex-col items-center mb-20">
            ...
            <div className="pt-10 pb-5 flex flex-col items-center">
                <div className="flex flex-col text-secondary w-[90vw] p-6 rounded-xl place-self-center text-center relative sm:w-[95vw]">
                    ...
                    <p className="text-xl flex flex-col pb-10 gap-5 lg:pb-0 lg:text-lg sm:text-base ">Votre demande de réservation pour organiser votre séance à bien été transmise.</p>
                </div> 
            </div>
            <div className="max-w-[1000px] w-[90%] mb-10 text-center flex flex-col items-center gap-5 bg-secondary text-white relative rounded-3xl justify-center pt-10 px-28 lg:px-10 sm:px-5">
                <p className="text-xl lg:text-lg md:text-base">Dès que nous aurons validé votre réservation vous recevrez un email pour finaliser votre réservation en payant la location de l’espace.</p>
                <p className="text-xl lg:text-lg md:text-base">Une fois votre paiement effectué nous créons votre évènement ou atelier en fonction des renseignements que vous nous avez transmis. Il sera publié sur notre site.</p>
                <div className="flex gap-5 -mb-[25px] mt-5 text-white font-medium text-lg lg:text-base md:text-sm md:-mb-[20px]">
                    <Link href='/contact' className="px-10 h-[50px] md:h-[40px] md:px-5 w-fit bg-primary rounded-[50px] flex items-center justify-center" onClick={clearCart}>Nous contacter</Link>
                </div>
            </div>
            <div className="flex flex-col text-secondary w-[90vw] p-6 rounded-xl place-self-center text-center relative sm:w-[95vw]">
