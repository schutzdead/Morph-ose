              ...
              <div className=" w-[500px] mr-20 md:mr-0 sm:max-w-[500px] sm:w-[90%]">
                <div  className="backdrop-blur-sm rounded-3xl pt-4 pb-5 bg-[#582D3E80]">
                  ...
                  <h1 className="text-white leading-[70px] font-Quesha text-8xl md:text-6xl md:leading-[40px]">Nos Séances individuelles</h1>
                    ...
                    <p className="font-medium text-lg md:text-base sm:text-sm">Etes vous prêt pour ce merveilleux voyage en notre compagnie ?</p>
                    <p className="font-bold text-lg md:text-base sm:text-sm">Etes-vous prêt à entamer la quête vers la nouvelle version de vous-même ?</p>
                  </div>
                </div>
    ...
    return(
        <div className="px-5 py-7 w-[480px] rounded-3xl flex flex-col gap-5 items-center text-center sm:w-[95vw]" style={index%2 === 0 ? {backgroundColor:'#E25E3E', color:'white'} : {backgroundColor:"#582D3E", color:'white'}}>
            ...
            <div className="flex flex-col w-[80%] gap-10 mt-5">
              <Link href={seance?.link ? `${seance?.link}` : "/seances"} target="_blank" className="py-2 w-full bg-mainGradient rounded-[50px] text-white font-medium text-lg relative md:text-sm">
