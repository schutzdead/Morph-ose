...
//             <label htmlFor={name} className="text-white text-lg  lg:text-base sm:text-sm">{label} {commonError && (<ErrorInput error={commonErrorMessage} />)}</label>
//             <textarea   className="text-typo rounded-[10px] bg-white p-4 focus-visible:outline-none md:p-2 md:text-sm" rows={height} placeholder={placeholder}
//                         id={name} {...options}>
//             </textarea>
//         </div>
//     )
