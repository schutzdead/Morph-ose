...
export function UpdateButton ({quantityValue, setQuantityValue, updateFct, article}) {
    ...
    return (
        <div className="z-[20] flex items-center gap-0.5 border border-black p-1 group hover:bg-secondaryLight select-none">
            <div className="cursor-pointer pl-1 pr-2" onClick={() => {updateQuantity(-1), updateCommand(article, -1)}}>-</div>
            <div className="text-center cursor-default">{quantityValue}</div>
